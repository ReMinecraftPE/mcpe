...
void Button::render(Minecraft* pMinecraft, int xPos, int yPos)
{
	...
	currentShaderColor = Color::WHITE* m_bOpacity;
	...
	Color textColor;
	if (!m_bEnabled)
		textColor = Color(160, 160, 160) * m_bOpacity; // 0xFFA0A0A0
	else if (m_bHovered)
		textColor = Color(255, 255, 160) * m_bOpacity; // 0xFFFFA0U
	else
		textColor = Color(224, 224, 224) * m_bOpacity; // 0xE0E0E0U
