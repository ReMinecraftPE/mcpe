...
void Recipes::addArmour(const ItemStack& material, Item* helmet, Item* chestplate, Item* leggings, Item* boots)
{
    add(ShapedRecipeBuilder("XXX",
...
Recipes::Recipes()
{
    ...
    // ArmorRecipes
    //addArmour(ItemStack(Item::leather), Item::clothHelmet, Item::clothChestplate, Item::clothLeggings, Item::clothBoots);
    //addArmour(ItemStack(Tile::fire), Item::chainHelmet, Item::chainChestplate, Item::chainLeggings, Item::chainBoots);
    //addArmour(ItemStack(Item::ironIngot), Item::ironHelmet, Item::ironChestplate, Item::ironLeggings, Item::ironBoots);
    //addArmour(ItemStack(Item::goldIngot), Item::goldHelmet, Item::goldChestplate, Item::goldLeggings, Item::goldBoots);
    //addArmour(ItemStack(Item::emerald), Item::diamondHelmet, Item::diamondChestplate, Item::diamondLeggings, Item::diamondBoots);
    ...
    //add(ShapedRecipeBuilder("A",
    //                        "B", ItemStack(Item::chestMinecart, 1))
    //    .add('A', Tile::chest)
    //    .add('B', Item::minecart));

    //add(ShapedRecipeBuilder("A",
    //                        "B", ItemStack(Item::furnaceMinecart, 1))
    //    .add('A', Tile::furnace)
    //    .add('B', Item::minecart));
