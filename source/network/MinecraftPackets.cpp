...
Packet* MinecraftPackets::createPacket(MinecraftPacketIds id)
{
	switch (id)
	{
		case PACKET_LOGIN:                 return new LoginPacket;
		case PACKET_LOGIN_STATUS:          return new LoginStatusPacket;
		case PACKET_READY:                 return new ReadyPacket;
		case PACKET_MESSAGE:               return new MessagePacket;
		case PACKET_SET_TIME:              return new SetTimePacket;
		case PACKET_START_GAME:            return new StartGamePacket;
		case PACKET_ADD_MOB:               return new AddMobPacket;
		...
		case PACKET_REMOVE_BLOCK:          return new RemoveBlockPacket;
		case PACKET_UPDATE_BLOCK:          return new UpdateBlockPacket;
		case PACKET_EXPLODE:               return new ExplodePacket;
		case PACKET_LEVEL_EVENT:           return new LevelEventPacket;
		case PACKET_TILE_EVENT:            return new TileEventPacket;
		case PACKET_ENTITY_EVENT:          return new EntityEventPacket;
		case PACKET_REQUEST_CHUNK:         return new RequestChunkPacket;
		case PACKET_CHUNK_DATA:            return new ChunkDataPacket;
		case PACKET_PLAYER_EQUIPMENT:      return new PlayerEquipmentPacket;
		case PACKET_INTERACT:              return new InteractPacket;
		case PACKET_USE_ITEM:              return new UseItemPacket;
		case PACKET_PLAYER_ACTION:         return new PlayerActionPacket;
		...
		case PACKET_DROP_ITEM:             return new DropItemPacket;
		case PACKET_CONTAINER_OPEN:        return new ContainerOpenPacket;
		case PACKET_CONTAINER_CLOSE:       return new ContainerClosePacket;
		case PACKET_CONTAINER_SET_SLOT:    return new ContainerSetSlotPacket;
